from alpharoute.algos.trailing import *
import alpharoute.algos.trailing as tl
import pytest
import pendulum
from alpharoute.order import CompoundOrder, Order
...
def test_can_start_trail_start_trailing_at(simple):
    ...
    with pendulum.travel_to(known):
        ...
        for v, e in zip(values, expected):
            with patch("alpharoute.algos.trailing.Trailing.mtm", v):
