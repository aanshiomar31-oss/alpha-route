...
from alpharoute.brokers.finvasia import *
...
def broker():
    ...
    with patch("alpharoute.brokers.api_helper.ShoonyaApiPy") as mock_broker:
...
def test_authenticate():
    ...
    with patch("alpharoute.brokers.finvasia.ShoonyaApiPy") as mock_broker:
        broker = Finvasia(
            "user_id", "password", "totpcode", "vendor_code", "app_key", "imei"
        )
        broker.authenticate()
