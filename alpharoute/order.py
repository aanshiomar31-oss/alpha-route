...
from alpharoute.base import *
from copy import deepcopy
from sqlite_utils import Database
from alpharoute.models import OrderLock
...
class Order(BaseModel):
    ...
    def __init__(self, **data) -> None:
        ...
        """
        super().__init__(**data)
        # from alpharoute.base import Broker # Import moved to methods to avoid circular dependency if Broker imports Order
    ...
    def execute(
        ...
        Note:
            The `alpharoute.base.Broker` import is done within this method to avoid
        ...
        from alpharoute.base import Broker as base_broker  # Moved import here
