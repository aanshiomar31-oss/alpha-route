...
from alpharoute.models import BasicPosition
...
def load_broker(
    ...
    from alpharoute.brokers.finvasia import Finvasia
    from alpharoute.brokers.icici import Icici
    from alpharoute.brokers.neo import Neo
    from alpharoute.brokers.noren import Noren
